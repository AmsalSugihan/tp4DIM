	...
	<div class="col-md-7 col-md-offset-2">
    		<form class="form-horizontal" method="post" action="barang_update.php">
                ...
                <div class="form-group">
                	<label for="nama_bagian" class="col-md-4"> Nama Barang  </label>
                	<div class="col-md-7">
                ...
                <div class="form-group">
                	<label for="Harga Barang" class="col-md-4"> Harga Barang  </label>
                	<div class="col-md-7">
                    	<input type="text" class="form-control" id="harga_barang" name="harga_barang" value="<?php echo $value['harga_barang']; ?>">
                    </div>
                </div>
                <div class="form-group">
                	<label for="Biaya Peyimpanan" class="col-md-4"> Biaya Penyimpanan  </label>
                	<div class="col-md-7">
                ...
                <div class="form-group">
                	<label for="periode permintaab" class="col-md-4"> Periode Permintaan  </label>
                	<div class="col-md-7">
                ...
                <div class="form-group">
                	<label for="Keterangan" class="col-md-4"> Konversi  </label>
                	<div class="col-md-7">
